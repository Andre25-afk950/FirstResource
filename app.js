...
video.src="https://drive.google.com/uc?export=view&id=1DgNw88S2GDuZnUWY77ydKQkkB4j0bKIY";
let createVideo = function(){
  let box = document.getElementsByClassName("vidio");
  
  let gambar = new Image();
  gambar.src="https://drive.google.com/uc?export=view&id=1FqBavQ62JiqONRh2sOOYNPJWyG71XVbL";
...
function btnPlay(){
    ...
    playImage.src = "https://drive.google.com/uc?export=view&id=1SIoMQRnJrcCFeHhojm1aN2HYnx31GGNM";
